<?php
   if(isset($_POST['name'])){
    ...
    $sql="INSERT INTO `register`.`table` ( `name`,`surname`,`email`,`password`) VALUES ('$name', '$surname', '$email', '$password')";
    // echo $sql;
...
<body>
  <div class="registration-container">
    ...
    <form action="register.php" method="post">
      ...
      <p>Already registered? <a href="dispaly.php">dispaly here</a></p>
  ...
  <script>
    document.getElementById("registrationForm").addEventListener("submit", function(event) {
      ...
      alert("EVENT REGISTERATION details saved successfully!");
    });
  </script>
</body>
</html>